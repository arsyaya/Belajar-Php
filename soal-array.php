...
<body>
    ...
    echo "Theres kids: ". $kids[0].", ".$kids[1].", ".$kids[2].", ".$kids[3].", ".$kids[4]." and ".$kids[5].". <br>";
    echo "Theres adults: ". $adults[0].", ".$adults[1].", ".$adults[2].", ".$adults[3]."and".$adults[4].". <br>";
